                ...
                <table className='table table-bordered mt-5 shadow'>
                  <thead>
                    <tr>
                      ...
                      <th className='text-center bg-secondary p-3'>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    {cartArray?.map((item, index) => (
                      <tr>
                        <td>{index + 1}</td>
                        <td>{item?.title}</td>
                        <td><img src={item?.thumbnail} alt="no image" width={'150px'} height={'150px'} /></td>
                        <td>$ {item?.price}</td>
                        <td className='text-center'><button onClick={() => dispatch(removeFromCart(item?.id))} className='btn btn-danger'><FontAwesomeIcon icon={faTrash} /></button></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
